...
class ScooterFormPage extends ConsumerStatefulWidget {
  const ScooterFormPage({super.key});

  @override
  ConsumerState<ScooterFormPage> createState() => _ScooterFormPageState();
}

class _ScooterFormPageState extends ConsumerState<ScooterFormPage> {
  ...
  bool _validateForm() {
    if (brandController.text.trim().isEmpty) {
      Fluttertoast.showToast(msg: "Please enter the scooter brand");
      return false;
    }
    ...
    if (modelController.text.trim().isEmpty) {
      Fluttertoast.showToast(msg: "Please enter the scooter model");
      return false;
    }
...
class ScooterFormPage extends ConsumerStatefulWidget {
  ...
  const ScooterFormPage({super.key, this.productToEdit});
...
class _ScooterFormPageState extends ConsumerState<ScooterFormPage> {
  ...
  void _prefillForm(SellList product) {
    ...
    if (jsonData != null) {
      ...
      modelController.text = jsonData['model'] ?? '';
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Center(
                  child: Text(
                    isEditing ? "Update Scooter Listing" : "Scooter Listing",
                    style: GoogleFonts.dmSans(
                      fontSize: 25.sp,
                      fontWeight: FontWeight.w600,
                      letterSpacing: -1,
                        ...
                        onPressed: isLoading
                          ...
                          try {
                            ...
                            final data = {
                              ...
                              "subcategory": "Scooters motorcycle",
                              "category": "Bikes",
                              "user_id": "${box.get("id")}",
                              "images[]": imageFiles,
                              "latitude": latitude,
                            ...
                            if (e is DioError && e.response?.statusCode == 429) {
                              ...
                              errorMessage = e.response?.data['message'] ??
                                  "Failed to process scooter listing. Please try again.";
                            }
                            Fluttertoast.showToast(
                              msg: errorMessage,
                              toastLength: Toast.LENGTH_LONG,
                        ...
                        onPressed: () async {
                          ...
                          try {
                            ...
                            if (needsPlan) {
                              ...
                              // Normal error pe current screen pe rehne do (ya Home bhej sakte ho)
                            }
                          }
                        },
                        child: Center(
