                      ...
                      ElevatedButton(
                        ...
                        onPressed: isLoading
                          ...
                          try {
                            ...
                            // Success → Clean navigation (back stack clear)
                            ...
                            if (e is DioError) {
                              ...
                              // Strong & reliable plan detection
                            ...
                            if (needsPlan) {
                              ...
                              Navigator.push(
                                ...
                                CupertinoPageRoute(
                                  builder: (context) => PlanPage(
                                    productData,  // ← Yeh sabse zaroori hai!
                                    true,         // requiresPlan = true
                                  ),
                                ),
                              );
                            }
                            // Normal error pe auto Home na jao — user retry kar sake
                          }
                        },
                        child: Center(
                          child: isLoading
