...
class CommercialFormPage extends ConsumerStatefulWidget {
  const CommercialFormPage({super.key});

  @override
  ConsumerState<CommercialFormPage> createState() => _CommercialFormPageState();
}

class _CommercialFormPageState extends ConsumerState<CommercialFormPage> {
  ...
  bool _validateForm() {
    ...
    if (typeController.text.trim().isEmpty) {
      Fluttertoast.showToast(msg: "Please enter the vehicle type");
      return false;
    }
    if (yearController.text.trim().isEmpty ||
        int.tryParse(yearController.text.trim()) == null ||
        int.parse(yearController.text.trim()) < 1900 ||
        int.parse(yearController.text.trim()) > currentYear) {
      Fluttertoast.showToast(
          msg: "Please enter a valid year (1900-$currentYear)");
      return false;
    }
    if (kmDrivenController.text.trim().isEmpty ||
      ...
      Fluttertoast.showToast(msg: "Please enter a valid kilometers driven");
      return false;
    }
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      FormBody(
                        labeltxt: "Vehicle Type*",
                        controller: typeController,
                        helper: "e.g., Truck, Van, Bus",
                      ),
                      SizedBox(height: 15.h),
                      FormBody(
                        labeltxt: "Year*",
                      ...
                      FormBody(
                        ...
                        helper:
                        "Mention key features (e.g., brand, model, condition)",
                      ),
                      SizedBox(height: 15.h),
                      FormBody(
...
class CommercialFormPage extends ConsumerStatefulWidget {
  ...
  const CommercialFormPage({super.key, this.productToEdit});
...
class _CommercialFormPageState extends ConsumerState<CommercialFormPage> {
  ...
  void _prefillForm(SellList product) {
    ...
    if (jsonData != null) {
      ...
      kmDrivenController.text = jsonData['km_driven'] ?? '';
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Center(
                  child: Text(
                    isEditing ? "Update Commercial Vehicle Listing" : "Commercial Vehicle Listing",
                    style: GoogleFonts.dmSans(
                      fontSize: 25.sp,
                      fontWeight: FontWeight.w600,
                      letterSpacing: -1,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      FormBody(
                        labeltxt: "Ad Title*",
                        controller: titleController,
                        helper: "Mention key features (e.g., brand, model, condition)",
                      ),
                      SizedBox(height: 15.h),
                      FormBody(
                        labeltxt: "Description*",
                      ...
                      //         );
                      //         Fluttertoast.showToast(
                      //           msg: "Commercial Vehicle Listing Updated Successfully",
                      //           toastLength: Toast.LENGTH_LONG,
                      //         );
                      //       } else {
                      //         await service.addProduct(data);
                      //         Fluttertoast.showToast(
                      //           msg: "Commercial Vehicle Listing Added Successfully",
                      //           toastLength: Toast.LENGTH_LONG,
                      //         );
                      //       }
                      //       Navigator.push(
                      ...
                      //       } else if (e is DioError) {
                      //         errorMessage = e.response?.data['message'] ??
                      //             "Failed to process commercial vehicle listing. Please try again.";
                      //       }
                      //       Fluttertoast.showToast(
                      //         msg: errorMessage,
                      //         toastLength: Toast.LENGTH_LONG,
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          // Product data ready karo jo PlanPage pe bhi ja sake
                          ...
                          try {
                            ...
                            // Success → Home pe jao aur purana stack clear kar do
                            ...
                            if (e is DioError) {
                              errorMessage = e.response?.data['message']?.toString() ??
                                  "Failed to process commercial vehicle listing.";
                            ...
                            if (needsPlan) {
                              ...
                              // Normal error pe user ko Home ya current screen pe rehne do
                              // Optional: Home pe bhej sakte ho
                              // Navigator.pushAndRemoveUntil(...)
                            }
                          }
                        },
