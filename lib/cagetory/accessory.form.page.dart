...
class _AccessoryFormPageState extends ConsumerState<AccessoryFormPage> {
  ...
  bool _validateForm() {
    if (typeControleller.text.trim().isEmpty) {
      Fluttertoast.showToast(msg: "Please enter the accessory type");
      return false;
    }
  ...
  Widget build(BuildContext context) {
    ...
    Map<String, dynamic> data = {
      "accessory_type": typeControleller.text,
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      FormBody(labeltxt: "Type*", controller: typeControleller),
                      SizedBox(height: 15.h),
                      FormBody(
                        labeltxt: "Ad title*",
...
class AccessoryFormPage extends ConsumerStatefulWidget {
  ...
  const AccessoryFormPage({super.key, this.productToEdit});
...
class _AccessoryFormPageState extends ConsumerState<AccessoryFormPage> {
  ...
  void _prefillForm(SellList product) {
    ...
    if (jsonData != null) {
      typeController.text = jsonData['accessory_type'] ?? '';
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Center(
                  child: Text(
                    isEditing ? "Update Accessory" : "Accessories",
                    style: GoogleFonts.dmSans(
                      fontSize: 25.sp,
                      fontWeight: FontWeight.w600,
                      letterSpacing: -1,
                      ...
                      /*  onPressed: isLoading
                          ...
                          try {
                            ...
                            final data = {
                              ...
                              "price": priceController.text,
                              "json_data": jsonEncode({
                                "accessory_type": typeController.text,
                                "title": titleController.text,
                            ...
                            if (e is DioError && e.response?.statusCode == 429) {
                              ...
                              errorMessage = e.response?.data['message'] ??
                                  "Failed to process accessory. Please try again.";
                            }
                            Fluttertoast.showToast(
                              msg: errorMessage,
                              toastLength: Toast.LENGTH_LONG,
                        ...
                        onPressed: isLoading
                          ...
                          // Images convert – try ke bahar (catch mein bhi use hoga)
                          List<MultipartFile> imageFiles = [];
                          for (var img in images) {
                            imageFiles.add(await MultipartFile.fromFile(
                              img.path,
                          ...
                          // Pending product data ready karo – PlanPage ko pass karne ke liye
                          ...
                          try {
                            ...
                            if (needsPlan) {
                              ...
                              Navigator.push(
                                ...
                                CupertinoPageRoute(
                                  builder: (context) => PlanPage(
                                    productData,  // ← Yeh critical hai!
                                    true,         // requiresPlan = true
                                  ),
                                ),
                              );
                            }
                            // Normal error pe user form pe reh jaye (retry kar sake)
                          }
                        },
                        child: Center(
                          child: isLoading
